...
const navigation = {
  main: [
    { name: "About", href: "#" },
    { name: "Privacy Policy", href: PRIVACY_POLICY_ROUTE },
    { name: "Terms Of Service", href: TERMS_OF_SERVICE_ROUTE },
    ...
    <footer className="bg-inherit">
      <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        ...
        <p className="mt-8 text-center text-base text-gray-400 dark:text-gray-300">
          &copy; {new Date().getFullYear()} Ldvloper, Inc. All rights reserved.
        </p>
      </div>
    </footer>
  );
