...
export const Pricing = () => {
  return (
    <div className="bg-gray-50 dark:bg-gray-950">
      ...
      <div className="mt-8 pb-12 bg-gray-50 dark:bg-gray-950 sm:mt-12 sm:pb-16 lg:mt-16 lg:pb-24">
        <div className="relative">
          <div className="absolute inset-0 h-3/4 bg-gray-100 dark:bg-gray-950" />
            ...
            <div className="max-w-md mx-auto space-y-4 lg:max-w-5xl lg:grid lg:grid-cols-3 lg:gap-5 lg:space-y-0">
              {PRICING_TIERS.map((tier) => (
                ...
                >
                  ...
                  <div className="flex-1 flex flex-col justify-between px-6 pt-6 pb-8 bg-gray-50 dark:bg-gray-900 space-y-6 sm:p-10 sm:pt-6">
