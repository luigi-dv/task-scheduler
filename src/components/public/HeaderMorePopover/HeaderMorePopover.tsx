...
import { RESOURCES_OBJECT } from "@/routes/public";
            ...
            {open && (
              ...
              >
                <motion.div
                  ...
                  className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden bg-white/95 dark:bg-black/95 px-5 py-6 sm:gap-8 sm:p-8 ease-in-out [--anchor-gap:var(--spacing-5)] data-[closed]:-translate-y-1 data-[closed]:opacity-0"
                >
